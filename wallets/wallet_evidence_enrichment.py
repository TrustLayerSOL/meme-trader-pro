...
def enrich_evidence_record(
    ...
    *,
    ...
    replay_by_mint: dict[str, dict[str, Any]],
) -> dict[str, Any]:
    enriched = dict(row)
    ...
    replay_outcome = replay_by_mint.get(mint)
...
def build_wallet_evidence_enrichment_report(
    *,
    ...
    replay_by_mint = replay_outcomes_by_mint(replay_events or [])
    rows = [
