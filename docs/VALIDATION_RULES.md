...
- First-two-hour raw lifecycle collection must hydrate only signatures observed between creation time and creation plus two hours, skip duplicate raw signatures, and preserve raw transactions for replay.
