...
def write_final_summary(
    ...
    *,
    ...
    summary = {
        ...
        "accountSubscribe_calls": status["accountSubscribe_calls"],
        "near_entry_live_watch_probe_rows": status["near_entry_live_watch_probe_rows"],
        "near_entry_live_watch_successes": status["near_entry_live_watch_successes"],
...
def _status_snapshot_md(payload: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            f"- accountSubscribe calls/live-watch rows/successes: `{payload['accountSubscribe_calls']}` / `{payload['near_entry_live_watch_probe_rows']}` / `{payload['near_entry_live_watch_successes']}`",
...
def _final_summary_md(summary: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            f"- accountSubscribe calls/live-watch rows/successes: `{summary['accountSubscribe_calls']}` / `{summary['near_entry_live_watch_probe_rows']}` / `{summary['near_entry_live_watch_successes']}`",
