...
| Wallet replay scorecard | per-wallet replay coverage, known/fillable outcomes, regime exposure, co-entry partners, and repeated co-entry pairs from replay events | `wallets/wallet_replay_scorecard.py`, `utils/build_wallet_replay_scorecard.py`, `data/wallet_replay_scorecard.json` |
