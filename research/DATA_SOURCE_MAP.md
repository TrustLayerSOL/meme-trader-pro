...
| Wallet outcome ledger | `data/wallet_outcome_ledger.json` | `data/paper_trades.json`, `data/rejected_signals/rejections.jsonl`, `data/wallet_performance.json`, `research.signal_schema` | First durable review artifact exists. It is generated, not live trading logic. Wallet-performance signals expand observation coverage but do not claim known outcomes. |
