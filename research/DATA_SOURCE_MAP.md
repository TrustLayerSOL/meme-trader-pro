...
| Wallet list apply | approved review decisions, lifecycle report, tracked wallets, paper-watch wallets, bad wallets, and candidate audit; promotions require paper-watch evidence plus lifecycle or candidate-audit support; apply runs under a local lock with unique backup stamps | `core/wallet_list_apply.py`, `utils/apply_wallet_review.py`, `desktop_api.py`, native Wallets tab, `data/wallet_review_decisions.json`, `data/wallet_candidate_audit.json`, `data/wallet_list_update_audit.json` |
