...
| Wallet replay scorecard | per-wallet replay coverage, known/fillable outcomes, regime exposure, co-entry partners, repeated co-entry pairs, read-only review queues for reviewable versus low-coverage wallets, conservative promotion/demotion/hold recommendations, and markdown/Obsidian operator report rendering | `wallets/wallet_replay_scorecard.py`, `wallets/wallet_replay_review.py`, `utils/build_wallet_replay_scorecard.py`, `obsidian_export/intelligence_notes.py`, `data/wallet_replay_scorecard.json`, `/api/wallet-replay-review` |
