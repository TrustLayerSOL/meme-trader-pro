...
| `/api/wallet-replay-review` | `data/wallet_replay_scorecard.json` | Read-only replay scorecard triage endpoint. Separates reviewable wallets from low-coverage wallets using known/fillable replay evidence and surfaces repeated co-entry pairs for ecosystem review. |
...
| Wallet replay scorecard | per-wallet replay coverage, known/fillable outcomes, regime exposure, co-entry partners, repeated co-entry pairs, and read-only review queues for reviewable versus low-coverage wallets | `wallets/wallet_replay_scorecard.py`, `wallets/wallet_replay_review.py`, `utils/build_wallet_replay_scorecard.py`, `data/wallet_replay_scorecard.json`, `/api/wallet-replay-review` |
