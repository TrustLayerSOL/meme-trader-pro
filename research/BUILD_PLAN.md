...
- <mark>Stage 8 - Replay Validation + Forward Testing: 35%</mark>

Reason:

- Stage 6 now has a complete conservative realism gate and refuses to score incomplete historical context.
- Historical replay currently has `6,042` events and `0` decision-time leakage flags.
- The next high-leverage step is validation/data coverage: reduce unknown-liquidity and unknown-outcome events, then acquire archival mint-account supply or reconstruct mint/burn history before market cap can become score-ready.
