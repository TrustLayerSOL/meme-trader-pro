...
- <mark>Stage 4 - Wallet Promotion/Demotion System: 30%</mark>
...
- Stage 3 is complete as a wallet evidence engine: current scorecard reviews `50` wallets, keeps `0` trusted promotions allowed, and makes the next action explicit for each wallet. It reports `36` wallets needing both outcome labels and market context, `9` needing outcome labels, `4` needing manual risk review, and `1` held out of paper-watch. Stage 4 should consume this scorecard conservatively for review-only promotion/demotion workflows.
