...
- <mark>Stage 3 - Wallet Evidence Engine: 60%</mark>
...
- The next high-leverage step is evidence collection: `46` candidate wallets need read-only wallet-history collection and `4` require risk review before wallet scores can be trusted.
