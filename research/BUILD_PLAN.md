...
- <mark>Stage 7 - Regime Detection: 10%</mark>
...
- Stage 7 is the next logical implementation area because wallet behavior should eventually be interpreted against market conditions. Regime labels exist in replay rows, but regime classification is not yet validated or score-driving.
