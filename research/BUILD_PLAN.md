...
- Stage 10 is intentionally deferred because proof readiness is still `2%`. The next practical implementation step is not risk automation; it is archival supply / market-cap recovery for the `591` near-score-ready rows that now have price and liquidity but still lack decision-time supply proof.
