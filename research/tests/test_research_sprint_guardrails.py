...
GUARDED_PATHS = [
    ...
    Path("research/mtp_research/validation/entity_proxy_rollout.py"),
    Path("research/mtp_research/validation/run_entity_proxy_rollout.py"),
    Path("research/mtp_research/validation/entity_coordination_proxy_thesis.py"),
    Path("research/mtp_research/validation/run_entity_coordination_proxy_thesis.py"),
    ...
    Path("research/mtp_research/validation/participation_quality_thesis.py"),
    ...
    Path("research/mtp_research/validation/t011_explosive_runner_raw_flow_robustness.py"),
